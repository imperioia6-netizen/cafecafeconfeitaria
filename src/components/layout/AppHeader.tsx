...
const AppHeader = ({ onToggleSidebar }: AppHeaderProps) => {
  ...
  return (
    <header className="sticky top-0 z-30 w-full backdrop-blur-2xl bg-background/80 border-b border-border/30">
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent/20 to-transparent" />
      <div className="w-full min-w-0 max-w-full mx-auto px-4 md:px-6 lg:px-8 flex items-center justify-between gap-2 py-3 md:py-4">
      <div className="flex items-center gap-3 min-w-0 flex-1 overflow-hidden">
        ...
        <div className="animate-fade-in min-w-0">
          ...
          {!isMobile && (
            <p className="text-sm text-muted-foreground/70 font-mono text-xs tracking-wide truncate">
