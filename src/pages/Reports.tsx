...
const PeriodTab = ({ days }: { days: number }) => {
  ...
  return (
    <div className="space-y-6 min-w-0 max-w-full">
      {/* KPI cards */}
      <div className="grid gap-3 md:gap-4 grid-cols-fit-2 lg:grid-cols-fit-4 min-w-0 w-full">
        {[
      ...
      {/* Charts */}
      <div className="grid gap-6 grid-cols-fit-1 lg:grid-cols-fit-2 min-w-0 w-full">
        {data.daily.length > 0 && (
